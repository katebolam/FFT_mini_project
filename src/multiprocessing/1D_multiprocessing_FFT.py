"""
# 1D_multiprocessing_FFT.py

This script implements a parallelized 1D Fast Fourier Transform (FFT) using Python's `multiprocessing` module for shared memory parallelization.
